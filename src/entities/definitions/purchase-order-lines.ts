...
export const purchaseOrderLineEntity: EntityDefinition = {
  name: "purchaseOrderLine",
  pluralName: "purchaseOrderLines",
  apiPath: "purchaseOrderLines",
  description:
    "Represents a line item on a purchase order in Business Central.",
  parentEntity: "purchaseOrder",
  parentNavigationProperty: "purchaseOrderLines",
  fields: [
    {
      name: "id",
      type: "guid",
    ...
    },
    {
      name: "documentId",
      type: "guid",
      description: "The unique identifier of the parent purchase order.",
    },
    {
      name: "sequence",
      type: "number",
    ...
    },
    {
      ...
      type: "decimal",
      readOnly: true,
      description: "The quantity already received for this line.",
    },
    {
