...
export const salesCreditMemoLineEntity: EntityDefinition = {
  name: "salesCreditMemoLine",
  pluralName: "salesCreditMemoLines",
  apiPath: "salesCreditMemoLines",
  description:
    "Represents a line item on a sales credit memo in Business Central.",
  parentEntity: "salesCreditMemo",
  parentNavigationProperty: "salesCreditMemoLines",
  fields: [
    {
      name: "id",
      type: "guid",
      readOnly: true,
      description: "The unique identifier for the sales credit memo line.",
    },
    {
      name: "documentId",
      type: "guid",
      description: "The unique identifier of the parent sales credit memo.",
    },
    {
      name: "sequence",
      type: "number",
    ...
    },
    {
      name: "lineType",
      type: "enum",
      description: "The type of the sales credit memo line.",
